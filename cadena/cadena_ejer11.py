...
# un número de unidades y muestre por pantalla una cadena con el siguiente formato:
#<producto>: <unidades> unidades x <precio>€ = <total>€
#donde <unidades> es el número de unidades con cinco dígitos, 
# <precio> es el precio unitario con 6 dígitos enteros y 2 decimales y <total> 
# es el coste total con 8 dígitos enteros y 2 decimales.
